...
define('CLASSTRACK_BASE_URL', 'http://localhost/classtrack');
...
define('CLASSTRACK_ENV', 'development'); // Change to 'production' for live deployment

// Email Settings
define('CLASSTRACK_ADMIN_EMAIL', 'admin@classtrack.system');
define('CLASSTRACK_SUPPORT_EMAIL', 'support@classtrack.system');
