// Settings JavaScript - ClassTrack Settings Page
...
function storeOriginalFormValues() {
    ...
    console.log('Original form values stored:', originalFormValues);
}
...
function initializeSaveButton() {
    ...
    if (saveButton) {
        ...
        updateSaveButtonState();
        console.log('Save button initialized. Original values:', originalFormValues);
    }
}
...
function updateSaveButtonState() {
    ...
    const fieldsToCheck = ['firstName', 'lastName', 'email', 'course', 'yearLevel', 'department', 'currentPassword', 'newPassword', 'confirmPassword'];
    ...
    console.log(`Save button state: hasChanges=${hasChanges}, allValid=${allValid}, shouldEnable=${shouldEnable}`);
...
// Save Information
function saveInfo() {
    console.log('=== SAVE INFO FUNCTION STARTED ===');
    ...
    console.log('Sending AJAX request to settings.php...');
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            showNotification(data.message || 'Profile information saved successfully!', 'success');
...
function resetForm() {
    ...
    console.log('Form reset to original values:', resetValues);
}
...
function handleProfilePhotoSelect(input) {
    ...
    reader.onload = function(e) {
        ...
        console.log('Profile photo selected and ready for upload:', {
            name: file.name,
            size: file.size,
            type: file.type
        });
...
console.log('ClassTrack Settings Page initialized successfully!');
